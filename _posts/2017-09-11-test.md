...
<img src="https://less.works/img/LeSS-overview-diagram.png" alt="less-overview-diagram" title="less-overview-diagram" width="100%" style="background-color:white">
<p align="center">LeSS の全体図 (※2)</p>
...
- Sprint Planning は 2 段階に分けて行い、一度目の Sprint Planning（上記図中の Sprint Planning 1）には、必ず全ての Team（もしくはその代表者）が参加する
...
<img src="https://less.works/img/framework/undone-work/causing-risk-and-delay.png" alt="causing-risk-and-delay" title="causing-risk-and-delay" width="80%" style="background-color:white">
